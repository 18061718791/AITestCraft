-- =====================================================
-- AITestCraft 数据库核心业务数据初始化脚本
-- 功能：删除原有表 -> 重新创建表结构 -> 导入核心业务数据
-- 生成时间: 2026-03-02
-- 数据库: aitestcraft (原: testcase_generator)
-- 注意：此脚本排除了 system_metrics 监控日志表（47万条记录）
-- =====================================================
...
CREATE DATABASE IF NOT EXISTS `aitestcraft` 
...
-- =====================================================
-- 4. 导入核心业务数据（排除 system_metrics 表）
-- =====================================================

-- 请使用以下命令导出核心业务数据并追加到此文件：
-- 
...
--   --ignore-table=testcase_generator.system_metrics \
--   >> migration\init_database_core.sql
--
-- =====================================================
